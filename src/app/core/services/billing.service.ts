...
export class BillingService {
	...
	// Dentro de BillingService
	getFacturasPendientes(identificacion: string): Observable<any[]> {
		// 1. Obtenemos la base de la URL sin barras extras
		const baseUrl = joinApiUrl(this.apiUrl, 'facturas-gestion/pendientes');

		// 2. Construimos la URL final asegurando que solo haya una / antes del ?
		// Si baseUrl ya termina en /, no agregamos otra.
